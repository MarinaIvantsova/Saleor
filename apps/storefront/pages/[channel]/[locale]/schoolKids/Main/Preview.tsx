function Preview() {
  return (
    <>
      ...
      <div className="flex justify-center items-center 2xl:min-h-[512px] 2xl:bg-[url('/main-photo.svg')] 2xl:bg-no-repeat 2xl:bg-100% md:bg-[url('/main-photo-tablet.svg')] md:bg-100% md:bg-no-repeat md:min-h-[441px] xs:bg-[url('/main-photo-mobile.svg')] xs:bg-no-repeat xs:bg-100% xs:min-h-[304px]">
        <section className="relative 2xl:w-[70%] 2xl:pt-[136px] 2xl:pb-[180px] before:absolute before:bg-[url('/car.svg')] before:top-[10%] before:-left-[15%] 2xl:before:w-[106px] 2xl:before:h-[84px] after:absolute after:top-[10%] after:left-[100%] 2xl:after:content-cloudIcon md:w-[90%] md:before:-top-[20%] md:before:-left-[5%] md:before:bg-[length:58px] md:before:w-[58px] md:before:h-[46px] xs:w-[85%] xs:py-[60px] xs:before:top-[4%] xs:before:-left-[5%] xs:before:bg-[length:48px] xs:before:w-[48px] xs:before:h-[38px]">
