function Process() {
  return (
    <section className="2xl:mt-[118px] md:mt-[98px] xs:mt-[55px] xs:mx-auto">
      <div className="flex relative flex-wrap mx-auto w-[90%] 2xl:w-[70%] before:absolute before:bg-no-repeat 2xl:before:bg-[url('/girl.svg')] before:top-[5%] before:-left-[15%] before:w-[105px] before:h-[115px] after:absolute after:bg-[url('/rocket.svg')] after:bg-no-repeat after:-top-[15%] after:left-[85%] 2xl:after:w-[135px] 2xl:after:h-[68px] md:after:bg-[length:101px] md:after:w-[101px] md:after:h-[50px] xs:min-w-[290px] xs:after:-top-[7%] xs:after:left-[80%] xs:after:w-[67px] xs:after:h-[34px] xs:after:bg-[length:67px]">
        ...
        <div className="w-[40%]">
          <h3 className="w-[90%] mb-[20px] 2xl:text-[20px] 2xl:leading-[30px] md:text-[18px] xs:text-[16px] xs:min-w-[176px] xs:leading-[22px] text-layoutTextColor font-montserrat font-medium">
        ...
        <div className="md:w-[50%] md:min-w-[355px] xs:w-full xs:min-w-[290px]">
          <h3 className="mb-[20px] 2xl:text-[20px] 2xl:leading-[30px] md:w-[70%] md:text-[18px] xs:w-[80%] xs:mt-[35px] xs:text-[16px] xs:leading-[22px] text-layoutTextColor font-montserrat font-medium">
