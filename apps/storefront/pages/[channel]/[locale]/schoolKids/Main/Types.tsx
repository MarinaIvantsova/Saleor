...
const TYPESITEMS = [
  {
    ...
    className: `before:bg-first-arrow before:w-[182px] before:h-[61px] before:bg-[length:182px] before:-top-[15%] before:right-[20%]
  md:before:bg-first-arrow-tablet md:before:w-[135px] md:before:h-[45px] md:before:bg-[length:135px] md:before:-top-0 md:before:left-[60%] 
  xs:before:bg-first-arrow-m xs:before:w-[66px] xs:before:h-[174px] xs:before:bg-[length:66px] xs:before:top-[100%] xs:before:-left-[2%] 
  xs:pt-0
  `,
  },
  {
  ...
  before:bg-second-arrow before:w-[115px] before:h-[126px] before:bg-[length:115px] before:top-[72%] before:left-[28%] 
  ...
  },
  {
    ...
    xs:mt-0 xs:-mt-[26px] xs:mb-[60px] xs:before:bg-fourth-arrow-m xs:before:w-[71px] xs:before:h-[200px] xs:before:bg-[length:71px] xs:before:-top-[100%] xs:before:left-[75%]
