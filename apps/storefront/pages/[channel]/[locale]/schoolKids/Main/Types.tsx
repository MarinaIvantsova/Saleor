...
const TYPESITEMS = [
  {
    ...
    className: `before:bg-[url('/first-arrow.svg')] before:w-[182px] before:h-[61px] before:bg-[length:182px] before:-top-[15%] before:right-[20%]
  md:before:bg-[url('/first-arrow-tablet.svg')] md:before:w-[135px] md:before:h-[45px] md:before:bg-[length:135px] md:before:-top-0 md:before:left-[60%] 
  xs:before:bg-[url('/first-arrow-m.svg')] xs:before:w-[66px] xs:before:h-[174px] xs:before:bg-[length:66px] xs:before:top-[100%] xs:before:-left-[2%] 
  xs:pt-0
  `,
  },
  {
  ...
  before:bg-[url('/second-arrow.svg')] before:w-[115px] before:h-[126px] before:bg-[length:115px] before:top-[72%] before:left-[28%] 
  md:before:w-[64px] md:before:h-[49px] md:before:bg-[length:64px] md:before:top-[70%] md:before:left-[30%] xs:before:w-[81px] xs:before:h-[71px] xs:before:bg-[length:81px]
  ...
  },
  {
    ...
    className: `2xl:before:bg-third-arrow 2xl:before:w-[115px] 2xl:before:h-[126px] 2xl:before:bg-[length:115px] 2xl:before:-top-[25%] 2xl:before:left-[40%]
  xs:before:bg-third-arrow xs:before:w-[57px] xs:before:h-[72px] xs:before:bg-[length:57px] xs:before:-top-[25%] xs:before:-left-[1%]`,
  },
  {
    id: 3,
    ...
    md:before:bg-fourth-arrow md:before:w-[110px] md:before:h-[50px] md:before:bg-[length:110px] md:before:top-[45%] md:before:left-0 
    xs:mt-0 xs:-mt-[26px] xs:mb-[60px] xs:before:bg-[url('/fourth-arrow-m.svg')] xs:before:w-[71px] xs:before:h-[200px] xs:before:bg-[length:71px] xs:before:-top-[100%] xs:before:left-[75%]
  ...
  return (
    <section className="w-[70%] mt-[130px] mx-auto 2xl:min-w-[1000px] md:w-[90%] md:min-w-[680px] xs:w-[90%] xs:mt-[20px] xs:min-w-[290px] xs:max-w-[380px]">
      ...
      <ul
       ...
       before:absolute before:bg-[url('/laughing.svg')] before:transform before:translate-x-[20%] before:z-10
